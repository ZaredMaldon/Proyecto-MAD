SELECT IC.TABLE_NAME,IC.COLUMN_NAME, IC.Data_TYPE, EP.[Value] as [MS_Description], IKU.CONSTRAINT_NAME,
ITC.CONSTRAINT_TYPE, IC.IS_NULLABLE,IC.CHARACTER_MAXIMUM_LENGTH
...
WHERE IC.TABLE_CATALOG = 'BD_MAD_1'
